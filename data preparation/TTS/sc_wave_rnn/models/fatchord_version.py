...
from sc_wave_rnn.distribution import sample_from_discretized_mix_logistic
from sc_wave_rnn.display import *
from sc_wave_rnn.audio import *
...
class WaveRNN(nn.Module):
    ...
    def __init__(self, rnn_dims, fc_dims, bits, pad, upsample_factors,
        ...
        self.I = nn.Linear(feat_dims + self.aux_dims + 1 + 256, rnn_dims) # add speaker embedding dimensions
